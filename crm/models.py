...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo',related_name="abc",limit_choices_to={"depart__in":[1,4]})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart__in":[3]})
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo',limit_choices_to={"depart__in":[1]})
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',limit_choices_to={"depart_id__in":[2]})
